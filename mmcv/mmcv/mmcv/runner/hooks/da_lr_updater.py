...
@DAHOOKS.register_module()
class DAFixedLrUpdaterHook(DALrUpdaterHook):

    def __init__(self, **kwargs):
        super(DAFixedLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DAStepLrUpdaterHook(DALrUpdaterHook):
    ...
    def __init__(self, step, gamma=0.1, **kwargs):
        ...
        self.step = step
        self.gamma = gamma
        super(DAStepLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DAExpLrUpdaterHook(DALrUpdaterHook):

    def __init__(self, gamma, **kwargs):
        self.gamma = gamma
        super(DAExpLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DAPolyLrUpdaterHook(DALrUpdaterHook):

    def __init__(self, power=1., min_lr=0., **kwargs):
        self.power = power
        self.min_lr = min_lr
        super(DAPolyLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DAInvLrUpdaterHook(DALrUpdaterHook):

    def __init__(self, gamma, power=1., **kwargs):
        self.gamma = gamma
        self.power = power
        super(DAInvLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DACosineAnnealingLrUpdaterHook(DALrUpdaterHook):

    def __init__(self, min_lr=None, min_lr_ratio=None, **kwargs):
        assert (min_lr is None) ^ (min_lr_ratio is None)
        self.min_lr = min_lr
        self.min_lr_ratio = min_lr_ratio
        super(DACosineAnnealingLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DACosineRestartLrUpdaterHook(DALrUpdaterHook):
    ...
    def __init__(self,
        ...
        super(DACosineRestartLrUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DACyclicLrUpdaterHook(DALrUpdaterHook):
    """Cyclic LR Scheduler.
    ...
    def __init__(self,
        ...
        super(DACyclicLrUpdaterHook, self).__init__(by_epoch, **kwargs)

    def before_run(self, runner):
        super(DACyclicLrUpdaterHook, self).before_run(runner)
        # initiate lr_phases
