_base_ = [
    ...
    '../_base_/schedules/schedule_1x.py', '../_base_/da_default_runtime.py'
]
model = dict(
...
test_cfg = dict(
    ...
    max_per_img=100)
optimizer = dict(lr=0.000125, paramwise_cfg = dict(custom_keys={
                'backbone': dict(lr_mult=100, decay_mult=1),
                'neck': dict(lr_mult=100, decay_mult=1),
                # bbox_head params------------------------------
                #'moment_transfer': dict(lr_mult=1, decay_mult=1),
                #'cls_convs': dict(lr_mult=1, decay_mult=1),
                #'reg_convs': dict(lr_mult=1, decay_mult=1),
                #'reppoints_cls_conv': dict(lr_mult=1, decay_mult=1),
                #'reppoints_cls_out'
