...
class DARepPointsHead(DAAnchorFreeHead):
    """RepPoint head.
    ...
    def _get_bboxes_single(self,
        ...
        mlvl_bboxes = []
        mlvl_scores = []
        #if img_metas[0]['ori_filename'] == 'frankfurt/frankfurt_000001_038645_leftImg8bit_foggy_beta_0.005.png': 
        #    pdb.set_trace()
        for i_lvl, (cls_score, bbox_pred, points) in enumerate(
            ...
            # import numpy as np
            # np.save('/lustre/S/wangyu/heatmap/' + img_metas[0]['ori_filename'].split('/')[1] + str(i_lvl) + '.npy', scores.cpu())
