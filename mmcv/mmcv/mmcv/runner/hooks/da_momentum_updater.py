...
from .da_lr_updater import annealing_cos


class DAMomentumUpdaterHook(DAHook):
...
class DACosineAnnealingMomentumUpdaterHook(DAMomentumUpdaterHook):
    ...
    def __init__(self, min_momentum=None, min_momentum_ratio=None, **kwargs):
        ...
        super(DACosineAnnealingMomentumUpdaterHook, self).__init__(**kwargs)
...
@DAHOOKS.register_module()
class DACyclicMomentumUpdaterHook(DAMomentumUpdaterHook):
    ...
    def before_run(self, runner):
        super(DACyclicMomentumUpdaterHook, self).before_run(runner)
